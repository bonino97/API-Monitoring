...
function OOTab(w, o) {
    ...
    var OpinionLabInit = function () {
    	...
    	var currentScript = 'oo_combined_engine_conf.min.js';
    	var oo_path = '';
    	
    	Array.prototype.forEach.call(scripts, function(el){
    		if(el.hasAttribute('src')){
    			var src = el.getAttribute('src');
	    		if(src.indexOf(currentScript) !== -1){
	    			oo_path = src.replace(currentScript, '');
	    		}
    		}
    	});
        ...
        o.oo_tab = new o.Ocode({
            ...
            // referrerRewrite: {
            //     searchPattern: /:\/\/[^\/]*/,
            //     replacePattern: '://tab.geico.com'
            // },
            disappearOnClick: true,
            customVariables: {
                hp: o.readCookie('hp'),
                quoteId: typeof quoteId === 'undefined' ? '' : quoteId,
                feedbackType: 'tab'
            },
            onPageCard: {
    ...
    o.addEventListener(window, 'load', OpinionLabInit, false);
}